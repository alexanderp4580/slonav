...
public:
     ...
     */
    MCP4922::ReferenceMode referenceMode(MCPDAC dac);
     ...
     */
    void referenceMode(MCPDAC dac, ReferenceMode mode);
     ...
     */
    MCP4922::GainMode gainMode(MCPDAC dac);
     ...
     */
    void gainMode(MCPDAC dac, GainMode mode);
     ...
     */
    MCP4922::PowerMode powerMode(MCPDAC dac);
     ...
     */
    void powerMode(MCPDAC dac, PowerMode mode);
     ...
     */
    void write(MCPDAC dac, float value);
     ...
     */
    void write_u16(MCPDAC dac, unsigned short value);
