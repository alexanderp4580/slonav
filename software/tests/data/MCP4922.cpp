...
MCP4922::ReferenceMode MCP4922::referenceMode(MCPDAC dac)
{
...
void MCP4922::referenceMode(MCPDAC dac, ReferenceMode mode)
{
...
MCP4922::GainMode MCP4922::gainMode(MCPDAC dac)
{
...
void MCP4922::gainMode(MCPDAC dac, GainMode mode)
{
...
MCP4922::PowerMode MCP4922::powerMode(MCPDAC dac)
{
...
void MCP4922::powerMode(MCPDAC dac, PowerMode mode)
{
...
void MCP4922::write(MCPDAC dac, float value)
{
    //Range limit value
    if (value < 0.0)
        value = 0.0;
...
void MCP4922::write_u16(MCPDAC dac, unsigned short value)
{
